// apps/web/src/components/toggle-user-role-button.tsx
"use client"
...
export function ToggleUserRoleButton({
    userId,
    currentRole
}: {
    userId: string
    ...
    return (
        <>
          ...
          ${currentRole === "ADMIN"
                ...
                title={currentRole === "ADMIN" ? "Понизить до пользователя" : "Повысить до админа"}
            >
                {currentRole === "ADMIN" ? (
            ...
            <AnimatePresence>
                ...
                ${currentRole === "ADMIN" ? "bg-amber-50" : "bg-violet-50"}`}>
                                {currentRole === "ADMIN" ? (
                    ...
                    rounded-2xl font-bold text-sm hover:bg-neutral-50 transition-all duration-200"
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className={`flex-1 px-4 py-2.5 rounded-2xl font-bold text-sm
                    ...
                    ${currentRole === "ADMIN"
                        ...
                        rounded-full animate-spin" />
                                        ...
                                        <>
                                            ...
                                            {currentRole === "ADMIN" ? "Понизить" : "Повысить"}
                                        </>
                                    )}
                                </button>
                            </div>
